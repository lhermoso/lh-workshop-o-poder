...
export const WorkshopContent: React.FC = () => {
    return (
        <section className="section bg-background-light dark:bg-[#0a0e17] text-gray-800 dark:text-white transition-colors duration-300">
            <div className="container-wide">
                <h2 className="section-header">O QUE TE ESPERA <span className="text-primary dark:text-primary-dark">NESSE WORKSHOP</span></h2>

                <div className="grid md:grid-cols-3 gap-8 mt-12">
                    <div className="crypto-card p-8 transform transition-all duration-300 hover:scale-105 glow-on-hover">
                        <div className="mb-6">
                            <div className="w-16 h-16 rounded-full bg-primary flex items-center justify-center mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-background-dark dark:text-background-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                                </svg>
                            </div>
                            <h3 className="text-2xl font-bold mb-2 text-gray-800 dark:text-white">Entenda a estratégia de sobreposição de Faixas</h3>
                        </div>
                    ...
                    <div className="crypto-card p-8 transform transition-all duration-300 hover:scale-105 glow-on-hover">
                        <div className="mb-6">
                            ...
                            <h3 className="text-2xl font-bold mb-2 text-gray-800 dark:text-white">Diminuição do impermanent loss</h3>
                        </div>
                        <p className="text-gray-600 dark:text-gray-300">
                    ...
                    <div className="crypto-card p-8 transform transition-all duration-300 hover:scale-105 glow-on-hover">
                        <div className="mb-6">
                            ...
                            <h3 className="text-2xl font-bold mb-2 text-gray-800 dark:text-white">Surra no Mercado</h3>
                        </div>
                        <p className="text-gray-600 dark:text-gray-300">
