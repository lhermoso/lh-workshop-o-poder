...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-background text-text py-10 relative overflow-hidden border-t border-primary/10">
      ...
      <div className="container-wide relative z-10">
        <div className="flex flex-col items-center">
          ...
          <p className="text-center text-sm mb-4 text-text/70">
            Copyright {currentYear} © Léo Hemoso · Todos os direitos Reservados
          </p>

          <div className="flex gap-4 text-xs text-text/50 mb-6">
          ...
          <div className="py-3 px-5 rounded-full glass-effect text-xs text-text/50 flex items-center gap-2">
