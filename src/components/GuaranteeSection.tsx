    ...
    return (
        <section className="section bg-background-light dark:bg-background-dark relative overflow-hidden transition-colors duration-300">
            ...
            <div className="container-wide relative z-10">
                <div className="crypto-card p-8 md:p-12 glow-on-hover">
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        <div className="relative w-48 h-48 flex-shrink-0 animate-float">
                            <div className="absolute inset-0 bg-gradient-to-br from-primary/30 to-accent/30 dark:from-primary/40 dark:to-accent/40 rounded-full blur-xl"></div>
                            <Image
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex items-center gap-3 glass-effect p-4 rounded-xl mb-6 text-gray-700 dark:text-gray-300">
                            ...
                            <CTAButton className="glow-on-hover" />
                        </div>
                    </div>
                </div>
            </div>
