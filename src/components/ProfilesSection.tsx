    ...
    return (
        <section className="section bg-background relative overflow-hidden">
            ...
            <div className="container-wide relative z-10">
                <h2 className="section-header font-orbitron">Com quem <span className="text-primary">você vai aprender</span></h2>
                <p className="text-center text-lg mb-16 max-w-3xl mx-auto text-text/80">
                ...
                <div className="flex flex-col md:flex-row gap-16 items-center justify-center mt-12">
                    <div className="relative w-64 h-64 md:w-80 md:h-80 group">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-primary/30 to-accent/30 rounded-2xl blur-xl group-hover:blur-lg transition-all duration-700"></div>

                        {/* Hexagon frame */}
                        <div className="absolute inset-0 z-10 overflow-hidden rounded-2xl border border-primary/20 bg-background-alt/30 backdrop-blur-sm"></div>
                        ...
                        {/* Crypto badge */}
                        <div className="absolute -bottom-3 -right-3 bg-background-alt backdrop-blur-md px-3 py-1 rounded-full text-sm font-medium z-20 border border-primary/20 shadow-glow flex items-center gap-2">
                    ...
                    <div className="crypto-card max-w-xl">
                        ...
                        <ul className="space-y-4 text-lg mb-8">
                            ...
                            <li className="flex items-start gap-3">
                                ...
                                <span>Possui mais de <span className="text-primary font-medium">4 bitcoins</span> em carteira</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0 mt-1">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li className="flex items-start gap-3">
                                ...
                                <span>Especialista em <span className="text-primary font-medium">pools de liquidez</span> e técnicas de &quot;yield farming&quot;</span>
                            </li>
                        </ul>
