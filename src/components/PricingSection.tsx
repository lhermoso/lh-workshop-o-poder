                            ...
                            <div className="relative p-8">
                                ...
                                <div className="flex flex-col md:flex-row gap-8 items-center">
                                    ...
                                    <div className="w-full md:w-1/2 text-center">
                                        ...
                                        <div className="text-6xl font-bold mb-6 flex items-center justify-center text-gray-800 dark:text-white">
                                        ...
                                        <form className="space-y-4" onSubmit={handleSubmit}>
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full pl-10 pr-4 py-3 bg-background-alt-light/50 dark:bg-background-alt-dark/50 border border-primary/30 dark:border-primary/40 rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-gray-800 dark:text-gray-200 placeholder-gray-500 dark:placeholder-gray-400"
                                                    required
                                                />
                                            </div>
                                            <div className="relative">
                                            ...
                                            <div className="flex items-center justify-center gap-3 pt-4 border-t border-primary/10 dark:border-primary/20">
